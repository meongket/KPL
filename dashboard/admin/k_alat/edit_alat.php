	...
	if (isset($_POST['submit'])AND($id)) {
		...
		if ($validJml) {
            ...
            if (!$result) {
              ...
              echo '<script language="javascript">alert("Alat berhasil diedit"); document.location="daftar_alat.php";</script>';
            }
        }else{
        	echo '<script language="javascript">alert("Terdapat masalah dalam sistem mohon hubungi pihak yang bersangkutan"); document.location="daftar_alat.php";</script>';
        }	
	}
              	...
              	<div class="col-md-12">
              		<form class="form-horizontal" method="POST" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?nomorid='.$id;?>">
						<div class="form-group">
							<label class="col-sm-2">Nama Alat</label>
							<div class="col-sm-8">
