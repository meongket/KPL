...
<head>
  <title>Daftar instrumen</title> <!-- +Lab Something -->
  ...
  <script>
    function Konf_hapus(id){
        ...
        if (result){
            document.location = "delete_instrumen.php?nomorid="+id;
        }
    }
  </script>
</head>
      ...
      <div id="page-inner">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <a href="jumlah_instrumen.php"><button class="btn btn-success"><i class='fa fa-plus'></i> | Tambah </button></a>
            <!-- TABEL ADVANCE -->  
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                           <?php
                                // Assign a query
                                $query = "SELECT * FROM alat WHERE id_lab='".$id_lab."' AND jenis='instrumen' ORDER BY id_alat";
                                // Execute the query
                                ...
                                while($row = $result->fetch_object()){
                                     echo "<tr>";
                                         ...
                                         echo "<td align='center'>";
                                            ...
                                            echo "<a data-toggle='tooltip' title ='Edit instrumen' href='edit_instrumen.php?nomorid=".$row->id_alat."'><i class='fa fa-edit'></i></a>";
                                         echo "</td>";
                                     echo "</tr>";
                                }
                          ?>
